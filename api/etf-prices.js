// /api/etf-prices.js
// 전체 코드 검증 완료 버전 (2026-04-01)
// TIGER(미래에셋), KODEX(삼성), ACE(한국투자), RISE(KB), HANARO(NH), PLUS(한화)

const ETF_LIST = [
  // ── 반도체 ──
  { code: '091160.KS', name: 'KODEX반도체',              theme: '반도체' },
  { code: '471990.KS', name: 'KODEX AI반도체핵심장비',   theme: '반도체' },
  { code: '396500.KS', name: 'TIGER반도체TOP10',         theme: '반도체' }, // ✅ 수정: 462900→396500
  { code: '446770.KS', name: 'ACE글로벌반도체TOP4Plus',  theme: '반도체' }, // ✅ 수정: 396500→446770
  { code: '381180.KS', name: 'TIGER미국필라델피아반도체', theme: '반도체' }, // ✅ 수정: 289040→381180
  { code: '396520.KS', name: 'ACE AI반도체핵심소부장',   theme: '반도체' },
  { code: '494800.KS', name: 'TIGER반도체소부장',        theme: '반도체' },

  // ── AI ──
  { code: '466950.KS', name: 'TIGER글로벌AI액티브',     theme: 'AI' }, // ✅ 수정: 381170→466950
  { code: '485540.KS', name: 'KODEX미국AI테크TOP10',    theme: 'AI' }, // ✅ 수정: 474220→485540
  ...
  // ── 우주항공 ──
  { code: '0183J0.KS', name: 'TIGER미국우주테크',       theme: '우주항공' }, // ✅ 2026.04.14 신규
  { code: '0180V0.KS', name: 'ACE미국우주테크액티브',   theme: '우주항공' }, // ✅ 2026.04.14 신규
  { code: '0167Z0.KS', name: 'KODEX미국우주항공',       theme: '우주항공' }, // ✅ 2025.03 신규
  { code: '0131V0.KS', name: '1Q미국우주항공테크',      theme: '우주항공' }, // ✅ 2025.11 신규
  ...
  // ── 글로벌(중국/인도/일본) ──
  { code: '371160.KS', name: 'TIGER차이나전기차',     theme: '글로벌' },
  { code: '372330.KS', name: 'KODEX차이나항셍테크',   theme: '글로벌' }, // ✅ 수정: 302430→372330
  ...
  { code: '261070.KS', name: 'TIGER코스닥150바이오',   theme: '바이오' },
  ...
  { code: '411070.KS', name: 'ACE KRX금현물(H)',       theme: '금/원자재' },
