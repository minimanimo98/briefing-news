...
const ETF_LIST = [
  ...
  { code: '457490.KS', name: 'TIGER방산', theme: '방산' },
  // 2차전지
  ...
  // 인버스/레버리지
  { code: '114800.KS', name: 'KODEX인버스', theme: '인버스' },
  { code: '252670.KS', name: 'KODEX200인버스2X', theme: '인버스' },
  { code: '122630.KS', name: 'KODEX레버리지', theme: '레버리지' },
  // 금/원자재
  ...
  // 리츠/배당
  { code: '395160.KS', name: 'TIGER리츠부동산', theme: '배당/리츠' },
